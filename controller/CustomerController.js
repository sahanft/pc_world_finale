...
function generateCustomerId() {
  ...
  // Increment the highest numeric part and format as "C-XXX"
...
// Auto-generate customer ID when the customer page is loaded
...
// Auto-generate customer ID when the document is ready
